...
struct ExchangeInfo: View {
    ...
    var body: some View {
        ZStack{
            ...
            //Vid 12-Step 16, Background parchment image
            Image(.parchment)
                .resizable()
                .ignoresSafeArea()
                .background(.brown)
            VStack{
                ...
                // -Step 18-Description text
                Text("Here at the Prancing Pony, we are happy to offer you a place where you can exchange all the known currencies in the entire world except one. We used to take Brandy Bucks, but after finding out that it was a person instead of a piece of paper, we realized it had no value to us. Below is a simple guide to our currency exchange rates:")
                    .font(.title2)
                    .padding()
                
                // Step-24,llamamos a nuestra vista "Exchange rates",y ahora podemos usar multiples instancias
            ...
            //Step-20, cambiamos todo el texto a negro para que se vea bien en el modo oscuro
